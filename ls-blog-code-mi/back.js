...
//            el.click();
//        }
//		if ($(".J_minus").next('input').val != 1){
////			setTimeout( function(){$(".J_minus")[0] && $(".J_minus")[0].click()},1000);
//			setTimeout($(".J_minus").click(),200);
//			setTimeout($(".J_minus").click(),200);
//			setTimeout($(".J_minus").click(),200);
//			setTimeout($(".J_minus").click(),200);
//			
...
//        }, 3200);
		//==================================
					if ($("#J_cartBar a:contains('去结算')")[0]) {
						setTimeout(function() {
			$("#J_cartBar a:contains('去结算')")[0].click();
							}, 7900);
			//观察到卡了一s在这里，所以加上这一句，上面那句其实就没有用了。
//			location.href = 'https://static.mi.com/cart/';
			//跑一个错误，中断线程。不再生成定时器。
...
//		}, interval);
		...
		//self innovation
//		alert($(this).val());
//		if($("input[name='2183600008_0_buy']") ){
//			$("input[name='2183600008_0_buy']").val("1");
//			$("input[name='2183600008_0_buy']").data-num("1");
//		}
